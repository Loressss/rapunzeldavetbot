...
async def start(event):
  await event.reply("**Rapunzel Etiketleme Botu**, Gruptaki tüm üyelerden bahsedebilir ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
...
async def help(event):
  helptext = "**Rapunzel Davet Bot'unun Yardım Menüsü**\n\nKomut: /all \n  Bu komutu, başkalarına bahsetmek istediğiniz metinle birlikte kullanabilirsiniz. \n`Örnek: /all Günaydın!`  \nBu komutu yanıt olarak kullanabilirsiniz. /bitir yazarak etiketleme işlemini bitirin. 🤗"
...
print(">> Bot çalıyor merak etme 👮‍♂️ @davetbotdestek bilgi alabilirsin <<")
